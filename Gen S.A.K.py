...
class NitroGen: # Initialise the class
    ...
    def main(self): # The main function contains the most important code
        ...
        if os.name == "nt": # If the system is windows
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator and Checker - Made by SadicX") # Change the
        else: # Or if it is unix
            print(f'\33]0;Nitro Generator and Checker - Made by SadicX\a', end='', flush=True) # Update title of command prompt
...
╚═════╝░╚═╝░░╚═╝╚═════╝░╚═╝░╚════╝░╚═╝░░╚═╝  ░╚═════╝░╚══════╝╚═╝░░╚══╝  ╚══════╝░╚════╝░╚══════╝╚══════╝
        ...
        self.slowType("Made by: Real SadicX", .02) # Print who developed the code
